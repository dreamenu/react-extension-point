...
var ExtensionPoint = function (_a) {
    ...
    registry = registry || React.useContext(ExtensionProvider_1.default);
    var Extension = registry && registry.getExtension && registry.getExtension(extensionName);
    ...
    return React.createElement(Extension, __assign({}, props));
};
